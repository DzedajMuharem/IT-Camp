...
// 1. charAt(index) - vraca nam karakter nekog stringa sa poslatim indexom
// 2. charCodeAt(index) - vraca nam kod karaktera nekog stringa sa poslatim indexom
// 2. string [index] - vrlo slicno charAt metodi, sa jednom razlikom

const novaRecenica = "Spava mi se.";
const char1 = novaRecenica.charAt(3);
const cahr11 = novaRecenica.charAt(46); // rezultat ce biti ""
console.log(char1);
